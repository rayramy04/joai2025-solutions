...
- 使用モデルはFacebookとOpenAIで迷った
  - 最終的に性能の良かったOpenAIを選択
...
- 使用モデル（言語）：OpenAIベース
  - 言語モデルは許可済みのOpenAIかFacebookのモデル、どちらを使うか迷った
  - 結局Facebookでもそこまで大きく変わらない性能はあった
  - が、OpenAIのほうがFacebookの改良版らしいとの情報
...
---
以上です。雑に書いてしまいましたが、また来年もやりたいです！運営の方々、ありがとうございました！